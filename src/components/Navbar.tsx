...
const Navbar = () => {
  ...
  const navLinks = [
    { name: t('navResearch'), href: '#research-label' },
    { name: t('navProducts'), href: '#products-label' },
    { name: t('navDevelopers'), href: '#developers-label' },
    { name: t('navMissionTeam'), href: '#mission-label' },
